...
class fragmentInici : Fragment(R.layout.fragment_inici) {
    ...
    companion object {
        ...
        fun newInstance(userId: Int) = fragmentInici().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Spinner y selección por defecto
        ...
        RetrofitClient.getClient()
            ...
            .enqueue(object : Callback<List<Eventos>> {
                override fun onResponse(
                    ...
                    else Log.e("fragmentInici", "Error eventos: ${response.code()}")
                }
    ...
    private fun esEventoFuturo(e: EventItem, hoy: LocalDate, fmt: DateTimeFormatter) =
        try { !LocalDate.parse(e.dataInici, fmt).isBefore(hoy) }
